#' Prepare data for plotMSE
#'
#' @param results dataframe generated by plot.MSE
#' @param multi.site Logical argument indicating whether several sites were simulated
#'
#' @return
#' @export
#'
#' @examples
prepareMSE <- function(results, multi.site = TRUE){
...
#' plot MultSE
#'
#' estimate the average of the MultSE generated for each source of
#' variation according to the repetitions of each sampling design. Values of the
#' mean, lower and upper quantiles are tabulated for each sampling effort. The
#' values are summarized in a dataframe.
#'
#' @param results from prepareMSE
#' @param multi.site TRUE or FALSE, default is TRUE
#'
#' @return
#' @export
#'
#' @examples
plotMSE <- function(results, multi.site = TRUE){
  to.plot <- datplot(results, multi.site = multi.site)
